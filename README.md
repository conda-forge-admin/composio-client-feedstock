About composio-client-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/composio-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/composio-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add composio-client
# for installing globally
pixi global install composio-client
```
...
It is possible to list all of the versions of `composio-client` available on your platform:
...
```
pixi search composio-client --channel conda-forge
```
